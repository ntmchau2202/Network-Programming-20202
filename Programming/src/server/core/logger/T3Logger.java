...
public class T3Logger {
    public static DateFormat DATE_FORMATER = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
    private static Logger LOGGER = getLogger(T3Logger.class.getName());
    static {
    ...
    public static String md5(String message) {
        ...
        try {
            ...
            T3Logger.getLogger(T3Logger.class.getName());
            digest = "";
        }
        return digest;
    }
     ...
     * @return boolean
     */
    public static boolean checkNotNullNorEmptyStr(final String testStr) {
